...
var tM=_n('view')
_rz(z,tM,'class',10,oJ,cI,gg)
var eN=_mz(z,'image',['bindtap',11,'class',1,'data-event-opts',2,'data-src',3,'src',4],[],oJ,cI,gg)
_(tM,eN)
_(lK,tM)
return lK
}
hG.wxXCkey=2
_2z(z,8,oH,e,s,gg,hG,'image','index','index')
var bO=_v()
_(oB,bO)
var oP=function(oR,xQ,fS,gg){
var hU=_n('view')
_rz(z,hU,'class',20,oR,xQ,gg)
var oV=_mz(z,'video',['control',-1,'class',21,'data-src',1,'src',2],[],oR,xQ,gg)
_(hU,oV)
_(fS,hU)
return fS
}
bO.wxXCkey=2
_2z(z,18,oP,e,s,gg,bO,'video','index','index')
_(r,oB)
return r
}
...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"cell-pd { padding: ",[0,22]," ",[0,30],"; }\n.",[1],"list-pd { margin-top: ",[0,50],"; }\n.",[1],"image_wrap { width: 90%; height: auto; margin: 5px auto; }\n.",[1],"image_wrap wx-image { width: 100%; height: 200px; }\n.",[1],"video_wrap { width: 90%; height: auto; margin: 5px auto; }\n.",[1],"video_wrap wx-video { width: 100%; height: 200px; }\n",],undefined,{path:"./pages/index/index.wxss"});    
